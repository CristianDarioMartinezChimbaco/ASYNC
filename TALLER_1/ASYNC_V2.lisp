...
;Aqui solo uso un hilo para crear la lista A	
	(let	
		(
			(hilo1 
...
;segunda face de los hilos, aqui se suman los impares y pares de la lista A de 
;500 datos y en simultaneo creo la lista b 	
	(let	
		(                                  
   			(hilo2
				(sb-thread:make-thread
...
;Tercera face, aqui simplemente ejecuto en simultaneo los las sumas de la lista B	
   	(let
		(
